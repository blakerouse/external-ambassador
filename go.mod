module github.com/blakerouse/external-ambassador
...
require (
	...
	github.com/gophercloud/gophercloud v0.0.0-20190212181753-892256c46858 // indirect
	...
	k8s.io/apimachinery v0.0.0-20190213030929-f84a4639d8e8
